...
class Actor(nn.Module):
    ...
    def get_log_prob1(self, state):
        ...
        return action_logprob.detach(), state_values, dist_entropy
...
class PPO(object):
    ...
    def train(self, replay_buffer):
        ...
        old_action_log_prob = self.actor.get_log_prob(old_state)
        action_prob = self.actor.get_log_prob(state)
