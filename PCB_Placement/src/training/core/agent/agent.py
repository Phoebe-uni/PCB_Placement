...
class agent(gym.Env):
    ...
    def step(self,
        ...
        if random is True:
            ...
            if rl_model_type == "TD3" or rl_model_type == "PPO" or rl_model_type == "DDPG" or rl_model_type == "DQN":
                ...
                model_action[2] = (action[2] - 0.5) * 2
                    ...
                    #log_prob = model.get_log_prob(_state)
        ...
        if rl_model_type == "TD3" or rl_model_type == "DDPG" or rl_model_type == "DQN":
