            ...
            for k,v in value.items():
                    ...
                    for fd in os.listdir(directory):
                        ...
                        if os.path.isdir(path):
                            ...
                            if len(name_fields) == 3:
                                ...
                                print(f'Append: {path}, {name_fields[0]}, {name_fields[1]}, {name_fields[2]} ')
                                all_recs.append(rec)
                ...
                for e in v["experiments"]:
                    for a in v["algorithms"]:
                        ...
                        if len(t) == 0:
                            print(f"[WARNING] Can not find any experiments for \"{e}\" using algorithm \"{a}\"")
                        else:
                            exp_algos.append(t)
